...
export class AppComponent {
  ...
  blends: any[] = [
    ...
    {title:"Fortissio lungo", description:"Бленд из&nbsp;100% арабики: эксперты подобрали идеальные пропорции индийской арабики Мунсун Малабар и&nbsp;колумбийской арабики из&nbsp;региона Каука. Зёрна из&nbsp;Индии получают естественную обработку под действием муссонных ветров, что даёт напитку насыщенный и&nbsp;плотный вкус, богатый сладкими злаковыми нотами, в&nbsp;то&nbsp;время как колумбийская арабика оттеняет бленд лёгкой кислинкой.", img:"Fortissiolungo", countries:["columbia", "india"], coordX:200, coordY:387},
    {title:"Livanto", description:"Чистая арабика из&nbsp;Южной и&nbsp;Центральной Америки, Коста-Рики и&nbsp;Колумбии. Livanto&nbsp;&mdash; это прекрасно сбалансированный эспрессо с&nbsp;характерной карамельной нотой, легким фруктовым ароматом и&nbsp;нотами обжарки.", img:"Livanto", countries:["costa-rica", "columbia", "gvatemala"], coordX:287, coordY:387},
    {title:"Kazaar", description:"Это насыщенный и&nbsp;крепкий бленд с&nbsp;густой кремистой текстурой, в&nbsp;составе которого два вида робусты из&nbsp;Гватемалы и&nbsp;Бразилии, а&nbsp;также бразильская арабика Черрадо. Для полного раскрытия потенциала каждого сорта кофе эксперты выбрали раздельный метод обжарки: сильная для робусты и&nbsp;длительная для арабики, что придаёт напитку сладкие ноты.", img:"Kazaar", countries:["gvatemala", "brasilia"], coordX:363, coordY:387},
