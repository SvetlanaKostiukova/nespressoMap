...
export class AppComponent {
  ...
  blends: any[] = [
    ...
    {title:"Livanto", description:"Америки, Коста-Рики и&nbsp;Колумбии. Livanto&nbsp;&mdash; это прекрасно сбалансированный эспрессо с&nbsp;характерной карамельной нотой, легким фруктовым ароматом и&nbsp;нотами обжарки.", img:"Livanto", countries:["costa-rica", "columbia", "gvatemala"], coordX:287, coordY:387},
